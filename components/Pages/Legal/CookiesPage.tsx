...
const CookiesPage = () => {
  return (
    <>
      <LegalHeader title="Cookie Policy" lastUpdated="September 15, 2025" />
      <section className="py-24 px-6 md:px-12">
        <div className="max-w-[800px] mx-auto text-secondary leading-relaxed space-y-12">
          
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-primary uppercase tracking-tight">1. What Are Cookies</h3>
            <p>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-primary uppercase tracking-tight">2. How We Use Cookies</h3>
            <p>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-primary uppercase tracking-tight">3. Disabling Cookies</h3>
            <p>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-primary uppercase tracking-tight">4. The Cookies We Set</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-primary uppercase tracking-tight">5. More Information</h3>
            <p>
