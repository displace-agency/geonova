  ...
  return (
    <section className="relative w-full h-[60vh] min-h-[500px] flex flex-col pt-[72px] justify-end pb-12 px-6 md:px-12 border-b border-primary/5 overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <img 
          src="https://cdn.prod.website-files.com/68d7e767f6f7f8719914fd01/6923469752c17043a009c49c_geonova4.jpg"
          alt="News Background"
      ...
      <div className="relative z-20 max-w-[1400px] mx-auto w-full">
        <span className="text-xs font-mono text-white/80 mb-6 block uppercase tracking-widest">Latest Updates</span>
